...
export const addStudentValidation = Yup.object().shape({
  ...
  quotaOfAdmission:Yup.string().label("This Field").required(),
  mode_of_addmission:Yup.string().label("This Field").required(),
  admissionRound:Yup.string().label("This Field").required(),
  course:Yup.string().label("This Field").required(),
  homeDept:Yup.string().label("This Field").required(),
  studyDept:Yup.string().label("This Field").required(),
  specialization:Yup.string().label("This Field"),
  studentSession:Yup.string().label("This Field").required(),
  academicSession:Yup.string().label("This Field").required(),
  firstName:Yup.string().label("This Field").required(),
  middleName:Yup.string().label("This Field"),
  lastName:Yup.string().label("This Field").required(),
  aadhar:Yup.number().label("This Field").integer().positive().min(99999999999 , "Aadhar Must be 12 digits").max(1000000000000 , "Aadhar Must be 12 digits").required(),
  email:Yup.string().label("This Field").email().required(),
  mobileNo:Yup.number().label("This Field").integer().positive().min(999999999 , "Mobile No. Must be 10 digits").max(10000000000 , "Mobile No. Must be 10 digits").required(),
  gender:Yup.string().label("This Field").required(),
  dateOfBirth:Yup.string().label("This Field").required(),
  bloodGroup:Yup.string().label("This Field").required(),
  jk_migrant:Yup.string().label("This Field").required(),
  category:Yup.string().label("This Field").required(),
  caste:Yup.string().label("This Field").required(),
  religion:Yup.string().label("This Field").required(),
  minority:Yup.string().label("This Field").required(),
  handicap:Yup.string().label("This Field").required(),
  hostel:Yup.string().label("This Field").required(),
  hobbies:Yup.string().label("This Field"),
  domecileState:Yup.string().label("This Field").required(),
  addressPermanent:Yup.object().shape({
  street1:Yup.string().label("This Field").required(),
  street2:Yup.string().label("This Field").required(),
  city:Yup.string().label("This Field").required(),
  district:Yup.string().label("This Field").required(),
  pincode:Yup.number().label("This Field").integer().positive().min(99999 , "Pincdoe Must be 6 digits").max(1000000 , "Pincdoe Must be 6 digits").required(),
  state:Yup.string().label("This Field").required(),
  }),
  addressLocal:Yup.object().shape({
  street1:Yup.string().label("This Field").required(),
  street2:Yup.string().label("This Field").required(),
  city:Yup.string().label("This Field").required(),
  district:Yup.string().label("This Field").required(),
  ...
  fatherName:Yup.string().label("This Field").required(),
  fatherMobileNo:Yup.number().label("This Field").integer().positive().min(999999999 , "Mobile No. Must be 10 digits").max(10000000000 , "Mobile No. Must be 10 digits").required(),
  fatherMail:Yup.string().label("This Field").nullable().email(),
  fatherOccupation:Yup.string().label("This Field").required(),
  fatherOccDescription:Yup.string().label("This Field").required(),
  motherName:Yup.string().label("This Field").required(),
  motherMobileNo:Yup.number().label("This Field").integer().positive().min(999999999 , "Mobile No. Must be 10 digits").max(10000000000 , "Mobile No. Must be 10 digits").required(),
  motherMail:Yup.string().label("This Field").nullable().email(),
  motherOccupation:Yup.string().label("This Field").required(),
  motherOccDescription:Yup.string().label("This Field").required(),
  guardianName:Yup.string().label("This Field"),
  guardianMobileNo:Yup.number().label("This Field").integer().positive().min(999999999 , "Mobile No. Must be 10 digits").max(10000000000 , "Mobile No. Must be 10 digits"),
  guardianAddress:Yup.object().shape({
    street1:Yup.string().label("This Field"),
    street2:Yup.string().label("This Field"),
    city:Yup.string().label("This Field"),
    district:Yup.string().label("This Field"),
    pincode:Yup.number().label("This Field").integer().positive().min(99999 , "Pincdoe Must be 6 digits").max(1000000 , "Pincdoe Must be 6 digits"),
    state:Yup.string().label("This Field"),
    }),
  guardianMail:Yup.string().label("This Field").nullable().email(),
  guardianRelation:Yup.string().label("This Field"),
  guardianOccupation:Yup.string().label("This Field"),
  guardianOccDescription:Yup.string().label("This Field"),
  migrationNo:Yup.string().label("This Field").required(),
  board12Name:Yup.string().label("This Field"),
  board12Year:Yup.number().label("This Field"),
  board12Physics:Yup.number().label("This Field"),
  board12Chemistry:Yup.number().label("This Field"),
  board12Maths:Yup.number().label("This Field"),
  board12total:Yup.number().label("This Field"),
  board12Maxmarks:Yup.number().label("This Field"),
  board10Name:Yup.string().label("This Field").required(),
  board10Year:Yup.number().label("This Field").required(),
  board10Physics:Yup.number().label("This Field").required(),
  board10Chemistry:Yup.number().label("This Field").required(),
  board10Maths:Yup.number().label("This Field").required(),
  board10total:Yup.number().label("This Field").required(),
  board10Maxmarks:Yup.number().label("This Field").required(),
  board10Cgpa:Yup.number().label("This Field").required(),
  otherCourse:Yup.string().label("This Field"),
  otherYear:Yup.string().label("This Field"),
  otherUni:Yup.string().label("This Field"),
  otherCgpa:Yup.number().label("This Field"),
  Jee_rollNo:Yup.number().label("This Field"),
  Jee_marks:Yup.number().label("This Field"),
  Jee_rank:Yup.number().label("This Field"),
  gate_rollNo:Yup.number().label("This Field"),
  gate_marks:Yup.number().label("This Field"),
  gate_percentile:Yup.number().label("This Field"),
  gate_rank:Yup.number().label("This Field"),
